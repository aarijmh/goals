...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#myModal').on('shown.bs.modal', function(e) {
			...
			$("#project").validate({
				...
				messages : {
					firstname : '<s:property value="getText('error.msg.first.name.required')" />'
				}
			});
	...
	$.ajax({
       		...
       		beforeSend: function(){
          			...
          			$("#savBtn").text('<s:property value="getText('please.wait')" />');
			...
			$("#savBtn").text('<s:property value="getText('save.changes')" />');
		//$('#loading').dialog('close');
					...
					$("#projectMessages").html('<s:property value="getText('project.saved.success')" />');
				...
				function(result) {
					if (result) {
						$.ajax({
							...
							bootbox.alert({
								message : '<s:property value="getText('project.delete.success')" />',
								title : '<s:property value="getText('project.delete.message')" />',
								closeButton : true
							});
...
<body>
	...
	<ul class="nav nav-pills">
		<li class="active"><a href="#"><s:property value="getText('projects')" /></a></li>

		<li><a href="learner.action?action=show"><s:property value="getText('learners')" /></a></li>
	</ul>
		...
		<div class="col-sm-10">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><s:property value="getText('projects')" /></h3>
				</div>
				<div class="panel-body">
					<div style="width: 80%; float:right;">
						<a href="project.action?action=showAddEdit&id=0"
							data-toggle="modal" data-target="#myModal"><i
							class="fa  fa-file fa-lg"></i></a> <a href="javascript:removeElements()"><i
						...
						<table id="projectTable">
							<thead>
								<tr>
									...
									<th><s:property value="getText('author')" /></th>
									<th><s:property value="getText('number.of.users')" /></th>
