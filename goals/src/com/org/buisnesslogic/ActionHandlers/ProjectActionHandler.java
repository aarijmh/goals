...
public class ProjectActionHandler extends AbstractActionHandler {
	...
	public void processing() {
		...
		if(project.getAction().equalsIgnoreCase(Constants.LOGGED) || project.getAction().equalsIgnoreCase(Constants.LOGGED_ADMIN))
			showProject();
	...
	public void showProject()
	{
		...
		if(Constants.ADMIN_TYPE.equals(project.getSession().get(Constants.LOGIN_TYPE)))
		{
			project.setAction(Constants.LOGGED_ADMIN);
		}
